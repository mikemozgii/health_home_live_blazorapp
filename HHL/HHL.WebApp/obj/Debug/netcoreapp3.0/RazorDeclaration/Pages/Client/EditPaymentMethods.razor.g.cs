...
#line hidden
    ...
    [Microsoft.AspNetCore.Components.RouteAttribute("/client/payment-methods")]
    public partial class EditPaymentMethods : Microsoft.AspNetCore.Components.ComponentBase
    {
...
#line 243 "c:\Users\mikek\source\repos\health_home_live_blazorapp\HHL\HHL.WebApp\Pages\Client\EditPaymentMethods.razor"
    ...
    {
        PaymentMethods = await ClientSvc.SelectCurrentPaymentMethods();
    }
    ...
    async void HandleAddPaymentMethodFormModelSubmit()
    {
        ...
        {
            var r = await ClientSvc.InsertPaymentMethod(AddPaymentMethodFormModel);
            if (r != null)
            {
                await FillClientPaymetMethods();
